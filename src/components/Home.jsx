  ...
  return (
    <div className="flex flex-col overflow-x-hidden">
      <div className="flex container flex-col mb-[74px] gap-6">
        <p className="text-customblack font-bold text-[256.5px] sm:text-[106px] leading-none">
          DO IT{" "}
          <span className="text-customblue sm:text-[106px] font-bold text-[256.5px] leading-none">
            RIGHT
          </span>
        </p>
        <div className="relative flex">
          ...
          <motion.p
            whileInView={{ y: 160, rotate: 90 }}
            transition={{ duration: 0.5 }}
            initial={{ y: 300, rotate: 90 }}
            className="rotate-90 text-customgray font-semibold md:p-8 sm:p-2 bg-customblack w-fit absolute rounded-t-xl -left-[76px]"
          >
          ...
          <div className="absolute px-12 pb-12 items-center w-full flex justify-between bottom-0">
            <div className="flex flex-col sm:mt-auto items-start">
              <p className="font-semibold text-white sm:text-5xl md:text-[74px]">
                NIKE AIR MAX
              </p>
              <p className="text-customgray sm:text-[20px] md:text-[24px]">
                Nike introducing the new air max for <br /> everyone's comfort
              </p>
              <button className="mt-6 text-white bg-customblue uppercase sm:py-[7.5px] sm:text-2xl sm:px-4 md:py-[15.5px] md:px-[32px] rounded-[5px]">
                Shop now
              </button>
            </div>
      ...
      <div className="flex flex-col gap-8 container w-full">
        <div className="flex justify-between">
          <p className="md:uppercase text-customblack sm:text-5xl md:text-[74px] sm:normal-case font-semibold leading-[95%]">
            Don’t miss out <br /> new drops
          </p>
          <button className=" text-white bg-customblue uppercase mt-auto sm:py-[11.5.5px] sm:text-2xl sm:px-4 md:py-[15.5px] md:px-[32px] h-fit sm:rounded-[8px] rounded-[5px]">
            Shop New Drops
          </button>
        </div>
      ...
      <div className="bg-customblack my-[128px]">
        <div className="w-full pt-[90px] flex flex-col gap-16">
          <div className="flex w-full container sm:px-4 justify-between">
            <p className="uppercase text-white text-[74px] font-semibold leading-[95%]">
              Categories
            </p>
            <div className="flex items-center gap-4 mt-auto">
              <button className="rounded-lg bg-customwhite transition-colors duration-150 hover:bg-customgraydark px-[10.5px] py-[8.5px]">
          ...
          <div className="rounded-tl-3xl relative sm:px-4 md:px-0 overflow-hidden sm:grid sm:grid-cols-1   md:flex md:items-center">
            <div className="bg-[#ECEEF0] w-full  flex flex-col relative justify-between items-center px-12 pb-[30px]">
              ...
              <div className="flex justify-between items-center w-full z-50 ">
                <p className="text-customblack text-4xl font-semibold">
                  Lifestyle <br />
                  Shoes
                </p>
                <Link
                  to={"/lifestyle"}
                  className="rounded-lg bg-customblack transition-colors duration-150 px-[10.5px] py-[8.5px]"
                >
                  <RiArrowRightUpLine color="#E7E7E3" size={24} />
                </Link>
              </div>
            </div>
            <div className="bg-[#F6F6F6] w-full flex flex-col relative justify-between items-center px-12 pb-[30px]">
              ...
              <div className="flex justify-between items-center w-full ">
                ...
                <button className="rounded-lg bg-customblack transition-colors duration-150 px-[10.5px] py-[8.5px]">
                  <RiArrowRightUpLine color="#E7E7E3" size={24} />
                </button>
              </div>
            </div>
      ...
      <div className="container flex flex-col gap-12 mb-[128px]">
        <div className="flex justify-between w-full">
          ...
          <button className=" text-white bg-customblue uppercase sm:py-[11.5.5px] sm:text-2xl sm:px-4 mt-auto md:py-[15.5px] md:px-[32px] h-fit rounded-[5px]">
            See all
          </button>
        </div>
        <div className="flex justify-between gap-[16.23px] items-center">
            ...
            <div className="bg-customwhite p-8 rounded-t-3xl flex flex-col gap-2">
              <div className="flex justify-between items-start">
                <div className="flex flex-col gap-2 w-full">
                  <p className="font-semibold md:text-2xl sm:text-4xl text-customblack">
                    Good Quality{" "}
                  </p>
                  <p className="text-customblack md:text-base sm:text-2xl opacity-80">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="font-semibold md:text-base sm:text-2xl text-customblack">
                  5.0
                </p>
              </div>
            </div>
          ...
          <div className="flex sm:hidden md:flex w-full h-full md:flex-col gap-0">
            <div className="bg-customwhite p-8 rounded-t-3xl flex flex-col gap-2">
              <div className="flex justify-between items-start">
                <div className="flex flex-col gap-2 w-full">
                  <p className="font-semibold text-2xl text-customblack">
                    Good Quality{" "}
                  </p>
                  <p className="text-customblack opacity-80">
                    I highly recommend shopping from kicks
                  </p>
                </div>
                <img src={usercircle} alt="" />
