        ...
        <div className='md:flex md:justify-between  md:mb-[128px]'>
            ...
            <div className='flex flex-col gap-8'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <Link to={"/buyitnow"} className='font-medium flex justify-center w-full text-white text-[14px] bg-customblue uppercase py-[15.5px] px-[32px] rounded-[5px]'>Buy it now</Link>
                </div>
                <div className='flex flex-col gap-2'>
        ...
        <div id='#cards' className='flex flex-col gap-8'>
          <div className='flex justify-between items-center'>
              ...
              <div className='overflow-x-hidden'>
                <div className='flex transition-transform ease-out items-center relative duration-500' style={{ transform: `translateX(-${curr * 100}%)` }}>
