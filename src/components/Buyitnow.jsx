    ...
    <div className="flex flex-col sm:px-4 md:p-0 text-customblack container mb-8">
      <div className="flex justify-between mb-8 items-center">
        <div className="flex flex-col w-full gap-8 items-start">
          <p className="text-xl w-fit font-semibold border-b border-b-[#79767C]">
          ...
          <div className="relative">
            <input
              className="py-[14.5px] peer bg-customgray w-[330px] border focus:outline-none border-customblack rounded-lg px-4"
              type="email"
              id="email"
              name="email"
              placeholder=""
            />
            <label
              className="absolute top-3 left-2 scale-90 peer-focus:top-3 peer-focus:scale-[0.8] text-[#79767C] peer-focus:left-3 peer-placeholder-shown:scale-100 transition-all duration-300 peer-placeholder-shown:left-3 peer-placeholder-shown:top-1/2 -translate-y-1/2"
              htmlFor="email"
            >
              Email
            </label>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="gap-5 flex flex-col">
              <div className="flex gap-5 justify-between">
                <div className="relative">
                  <input
                    className="py-[14.5px] peer bg-customgray w-full border focus:outline-none border-customblack rounded-lg px-4"
                    type="text"
                    id="email"
                    name="email"
                    placeholder=""
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-[#36323B]">
              ...
              <div className="flex flex-col gap-20 justify-between">
                <div className="flex gap-20 justify-between">
                  <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                      <p className="text-[20px] text-customblack font-semibold">
                    ...
                    <p className="text-[20px] text-customblue font-semibold">
                      $130
                    </p>
                  </div>
                </div>
      ...
      <button className="font-medium flex justify-center w-fit text-white text-[14px] bg-customblack uppercase py-[15.5px] mt-12 px-[122.5px] rounded-[5px]">
        Review AND PAY
      </button>
    </div>
  );
